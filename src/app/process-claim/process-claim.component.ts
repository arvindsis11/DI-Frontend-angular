...
export class ProcessClaimComponent implements OnInit {
  ...
  // }
  onSubmit(){
    this.createClaimForm.value.username = sessionStorage.getItem('loggedUser');
    ...
    this.createClaimData.username = this.createClaimForm.value.username;
    ...
    let id = this.createClaimForm.value.policy_id;
