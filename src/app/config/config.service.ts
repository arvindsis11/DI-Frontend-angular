...
export class ConfigService {
  ...
  getWallets(token:string){
    ...
    return this.http.get<WalletModel[]>(this.walletserviceUrl+"/view-all-wallets/"+this.userId,options);
  }
  ...
  getWalletBalance(token:string){
    ...
    return this.http.get<number>(this.walletserviceUrl+"/total-balance/"+this.userId,options);
  }
...
//fetch all the available policies--transaction history
  getAllPolicies(token:string){
    ...
    return this.http.get<Policymodel[]>(this.policyserviceUrl+"/view-policy/"+this.userId,options);
  }
  ...
  getAllClaims(token:string){
    ...
    return this.http.get<Claimmodel[]>(this.policyserviceUrl+"/view-claim/"+this.userId,options);
  }
  //........................................
